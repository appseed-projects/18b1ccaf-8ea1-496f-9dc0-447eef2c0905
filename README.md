...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-14 14:13`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/18b1ccaf-8ea1-496f-9dc0-447eef2c0905.git
$ cd 18b1ccaf-8ea1-496f-9dc0-447eef2c0905
```
